    ...
    .then(function () {
      ...
      return knex('treasure_table').insert([
        ...
        },
        {
          ...
          "treasuretable_cost" : "50",
          "treasuretable_description" : "A set of keys on a ring is found, for any door encountered, roll a D6: 1-4 = no key fits, 5-6 = the key needed is on the ring!"
        }
      ]);
    });
}; 
