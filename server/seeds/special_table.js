    ...
    .then(function () {
      ...
      return knex('special_table').insert([
        ...
        },
        {
          ...
          "specialtable_description" : "Warriors adjacent to the wearer at the end of the turn suffer 1D6 Wounds with no mods for Tough. or armour. This is Fatal Damage."
        },
        {
          "specialtable_id" : 79,
          "specialtable_type" : "Orcs and Goblins",
          ...
          "specialtable_description" : "The Shaman floods his allies with power. All Orcs and Goblins on the board get +1 Attack this turn and +1 Toughness next turn."
        }
      ]);
    });
}; 
